...
import { MultiStepProgress } from "@/components/assistant-ui/multi-step-progress";
import { ToolSuggestions } from "@/components/assistant-ui/tool-suggestions";
  ...
  return (
    <LazyMotion features={domAnimation}>
      <MotionConfig reducedMotion="user">
        ...
        >
          <ThreadPrimitive.Viewport className="aui-thread-viewport relative flex flex-1 flex-col overflow-x-hidden overflow-y-auto px-4">
            ...
            <ThreadPrimitive.If empty={false}>
              <div className="aui-thread-viewport-spacer min-h-8 grow pb-4" />
            </ThreadPrimitive.If>
...
const MultiStepProgressTracker: FC = () => {
  ...
  // Only show if there are multiple steps (multi-step workflow)
...
const Composer: FC = () => {
  return (
    <div className="aui-composer-wrapper mx-auto flex w-full max-w-[var(--thread-max-width)] flex-col gap-4 overflow-visible rounded-t-3xl bg-background px-4 pt-4 pb-4 md:pb-6">
...
const ComposerAction: FC = () => {
  ...
  const handleToolSelect = (prompt: string) => {
    // Set the composer value and submit
  ...
  return (
    <div className="aui-composer-action-wrapper relative mx-1 mt-2 mb-2 flex items-center justify-between">
      <div className="flex items-center gap-1">
        <ComposerAddAttachment />
        <ToolSuggestions onSelectTool={handleToolSelect} />
      </div>
